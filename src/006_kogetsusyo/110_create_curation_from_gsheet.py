...
df = pd.read_excel('data/湖月抄・NIJL・鵜飼文庫本への大成番号付与.xlsx', index_col=None, sheet_name=None)
...
for vol in range(1, 24):
    print(vol)
    curation_uri = "https://raw.githubusercontent.com/nakamura196/genji_curation/master/docs/iiif/nijl_kuronet_taisei_all/"+str(vol).zfill(2)+".json"
    ...
    curation_data["selections"][0]["within"]["label"] = "湖月抄・NIJL・鵜飼文庫本"
    ...
    f2 = open("../../docs/iiif/fb/"+str(vol).zfill(2)+"/湖月抄・NIJL・鵜飼文庫本.json", 'w')
