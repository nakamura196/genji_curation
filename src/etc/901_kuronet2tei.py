...
main_file_path = "data/list.csv"

df_item = pd.read_csv(main_file_path, index_col=None)
...
for i in range(len(df_item.index)):
    uri = df_item.iloc[i, 0]
    print(uri)
...
for manifest in map:
    ...
    f2 = open("../docs/iiif/kuronet/"+id+".json", 'w')
