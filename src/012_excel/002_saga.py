...
for vol in range(1, 55):
    ...
    try:
        ...
        url = "https://raw.githubusercontent.com/nakamura196/genji_curation/master/docs/iiif/121_saga/"+str(vol).zfill(2)+".json"
        
        with open("/Users/nakamura/git/d_genji/genji_curation/docs/iiif/121_saga/"+str(vol).zfill(2)+".json") as f:
