...
df = pd.read_excel('/Users/nakamura/git/d_genji/kouigenjimonogatari.github.io/src/data/metadata.xlsx', header=None, index_col=None)
...
for vol in configs:
    ...
    f2 = open(path.replace("/kuronet/", "/021_taisei/"), 'w')
